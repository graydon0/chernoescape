...
//hint format ["%1",NORRN_player_units]; 
...
"norrnRNoDam" 	addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\noDamage.sqf"};
"norrnDam"    	addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\allowDamage.sqf"};
"norrnRaDrag"   addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\animDrag.sqf"};
...
"norrnRaHl"     addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\animHealed.sqf"};
"norrnRrTB"     addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\rolltoback.sqf"};
"norrnRrTF"     addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\rolltofront.sqf"};
"norrnRName"    addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\promptRName.sqf"};
"norrnRalie"   	addPublicVariableEventHandler {[_this select 1] execVM "revive_sqf\pvEH\lieStill.sqf"};
